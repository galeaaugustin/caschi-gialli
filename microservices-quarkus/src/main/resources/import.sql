...
insert into roles (name, permissions) values ('CUSTOMER', 'VIEW_CUSTOMER_DETAILS,UPDATE_CUSTOMER_DATA,SEND_MESSAGE');
insert into roles (name, permissions) values ('SUPPLIER', 'VIEW_SUPPLIER_DETAILS,UPDATE_SUPPLIER_DATA,SEND_MESSAGE');
...
insert into users (id, username, password, email) values (4, 'customer', '$2a$16$6AZvwlL1PCJ7fgoNVBlezOnoB6WkZlmj6mvQPP5/0uWyso8nVOdXm', 'customer@test.io');
insert into users (id, username, password, email) values (5, 'supplier', '$2a$16$6AZvwlL1PCJ7fgoNVBlezOnoB6WkZlmj6mvQPP5/0uWyso8nVOdXm', 'supplier@test.io');
...
insert into user_roles (user_id, role_name) values (4, 'CUSTOMER');
insert into user_roles (user_id, role_name) values (5, 'SUPPLIER');